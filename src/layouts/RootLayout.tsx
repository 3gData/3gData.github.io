...
export default function RootLayout({ children }: RootLayoutProps) {
  return (
    <Website>
      <Helmet>
        <title>4gdev — Roblox Game Developer</title>
        <meta name="description" content="Professional Roblox game developer specializing in Luau scripting, game systems, and multiplayer experiences. Available for commissions." />
      </Helmet>
      <ScrollRestoration />
      <Header />
      {children}
